classdef GratingWithOffset < stage.core.Stimulus
    % A vertical grating stimulus with an offset (mean luminance)
    ...
    methods
        ...
        function obj = GratingWithOffset(profile, resolution)
