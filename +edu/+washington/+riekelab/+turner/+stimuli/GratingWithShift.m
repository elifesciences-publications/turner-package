classdef GratingWithShift < stage.core.Stimulus
    ...
    methods
        ...
        function obj = GratingWithShift(profile, resolution)
    ...
    methods (Access = private)
        ...
        function updateVertexBuffer(obj)
            ...
            vertexData = [-1  1  0  1,  0+phaseShift+x        1+y,  0  1 ...
                          -1 -1  0  1,  0+phaseShift+x        0+y,  0  0 ...
                           1  1  0  1,  nCycles+phaseShift+x  1+y,  1  1 ...
                           1 -1  0  1,  nCycles+phaseShift+x  0+y,  1  0];
