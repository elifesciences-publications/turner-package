classdef LinearEquivalentAnnulus < edu.washington.riekelab.protocols.RiekeLabStageProtocol
    ...
    properties
        ...
        linearIntegrationFunction = 'gaussian surround'
    ...
    properties (Hidden)
        ...
        linearIntegrationFunctionType = symphonyui.core.PropertyType('char', 'row', {'gaussian surround','uniform'})
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            RF = fspecial('gaussian',2.*[radX radY] + 1,sigmaS);
            ...
            if strcmp(obj.linearIntegrationFunction,'gaussian surround')
                weightingFxn = annulusMatrix .* RF; %set to zero mean gray pixels
            elseif strcmp(obj.linearIntegrationFunction,'uniform')
                weightingFxn = annulusMatrix;
            end
